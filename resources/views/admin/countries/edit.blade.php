                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Uredi državu</h3>
                            </div>
                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1 flex items-center">
                                                <input type="text" id="country_code" name="country_code"
                                                    class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" value="{{$country->country_code}}"/>
                                            </div>
                                        </div>
                            ...
                            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                <div class="py-2 align-middle inline-block w-full sm:px-6 lg:px-8">
                                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                        <div class="m-2 p-2">Županije</div>
