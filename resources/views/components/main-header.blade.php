<header class="text-gray-600 body-font">
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
      ...
      <a href="mailto:milos.andrej1@gmail.com" class="mr-5 hover:text-gray-900">Kontakt</a>
      @guest
    ...
    <a href="{{route('listings.create')}}"
      class="inline-flex items-center bg-blue-600 border-0 py-1 px-3 focus:outline-none hover:bg-blue-500 rounded text-base text-black font-semibold mt-4 md:mt-0">Objavi oglas
