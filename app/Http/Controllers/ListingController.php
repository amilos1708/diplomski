...
class ListingController extends Controller
{
    ...
    public function store(StoreListingRequest $request)
    {
        ...
        return redirect()->route('listings.index')->with('message', 'Oglas uspješno kreiran');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('listings.index')->with('message', 'Oglas uspješno ažuriran');
    }
    ...
    public function destroy($id)
    {
        ...
        $listing->delete();
        return redirect()->route('listings.index')->with('message', 'Oglas uspješno obrisan');
    }
}